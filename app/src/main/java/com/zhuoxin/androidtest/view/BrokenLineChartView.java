package com.zhuoxin.androidtest.view;
...
import com.zhuoxin.androidtest.MainActivity;
...
public class BrokenLineChartView extends View {
    ...
    // 左上角Y
    public  int LEFTUPY = 50;
    // 左下角Y
    public  int LEFTDOWNY = 600;
    // 右下角x
    private int RIGHTDOWNX = 400;
    // 上下间隔
